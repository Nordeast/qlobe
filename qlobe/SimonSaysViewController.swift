...
class SimonSaysViewController: UIViewController {
    ...
    @IBOutlet weak var rewardPotP2: UILabel!
    @IBOutlet weak var rewardPotP2Value: UILabel!
    
    @IBOutlet weak var Player1ScoreValue: UILabel!
    @IBOutlet weak var Player1ScoreLabel: UILabel!
    @IBOutlet weak var rewardPotP1: UILabel!
    @IBOutlet weak var rewardPotP1Value: UILabel!
    ...
    func design(){
        ...
        rewardPotP2.transform = CGAffineTransformMakeRotation(CGFloat(M_PI))
        rewardPotP2Value.transform = CGAffineTransformMakeRotation(CGFloat(M_PI))
        
        //countdown
        countDown.font = UIFont(name: "Kankin", size: 50.0)
        countDown.textColor = UIColor(netHex: 0xeeeeee)
        ...
        rewardPotP2.font = UIFont(name: "Kankin", size:  25.0)
        rewardPotP2.textColor = UIColor(netHex: 0xeeeeee)
        rewardPotP2Value.font = UIFont(name: "Kankin", size:  25.0)
        rewardPotP2Value.textColor = UIColor(netHex: 0xeeeeee)
        ...
        rewardPotP1.font = UIFont(name: "Kankin", size:  25.0)
        rewardPotP1.textColor = UIColor(netHex: 0xeeeeee)
        rewardPotP1Value.font = UIFont(name: "Kankin", size:  25.0)
        rewardPotP1Value.textColor = UIColor(netHex: 0xeeeeee)
        ...
        if(!gameOver){
            if(turn == 2){
                if(sequence[index] == 1){
                    ...
                    rewardPotP1Value.text = "\(reward)"
                    rewardPotP2Value.text = "\(reward)"
                    turn -= 1
                    index += 1
                }
                else{
